...
export class NavbarComponent {
  ...
  static pathloginauth: string = 'login_auth';
  urlLoginauth: string = '/' + NavbarComponent.pathloginauth;
  ...
  constructor(private router: Router, public auth : AuthService, public tokenStorage : TokenStorageService) {
    ...
    if(auth.isAuthenticated$){
      this.isConnected = false;
       ...
       this.auth.user$.subscribe(result => {
        ...
        this.tokenStorage.saveTokenAuth0(profile["name"]);
