...
{
    [Table("Stock")]
    public sealed class StockSqlDtos : IEquatable<StockSqlDtos>
    {
        ...
        public StockSqlDtos(string name, float value, string entrepriseName)
        {
            _id = Guid.NewGuid();
        ...
        public bool Equals(StockSqlDtos? other)
        {
