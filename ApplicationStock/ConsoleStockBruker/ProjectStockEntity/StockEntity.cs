...
{
    [Table("Stock")]
    public sealed class StockSqlEntity : IEquatable<StockSqlEntity>
    {
        ...
        public StockSqlEntity(string name, float value, string entrepriseName)
        {
            _id = Guid.NewGuid();
        ...
        public bool Equals(StockSqlEntity? other)
        {
